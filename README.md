...
MIT License — используйте свободно, но помните об ответственности.

---

## ⚖️ Юридическая ответственность

Авторы проекта не несут ответственности за неправомерное использование инструмента. Всегда получайте письменное разрешение перед сканированием чужих ресурсов.
